...
Ссылкой «Забыли пароль?» на странице входа можно назначить новый пароль по email и `APP_SETUP_TOKEN` из серверного `.env`. Авторизованный родитель меняет пароль в разделе «Профиль родителя» после ввода текущего пароля. Оба сценария завершают все активные родительские сессии; прежний пароль восстановить или посмотреть невозможно.
