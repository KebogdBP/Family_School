    ...
    const fetchMock = vi
      ...
      .mockImplementationOnce(() =>
        json({
          available: true,
          completed: false,
          routeTitle: 'Дроби: стартовая проверка',
          questions: [
        ...
        json(
          {
            ...
            result: {
              ...
              recommendedTopicTitle: 'Дробь как часть целого',
              recommendedLessonId: 'lesson-1',
              recommendedLessonTitle: 'Доля и целое',
              completedAt: '2026-09-10 10:00:00',
            },
          },
          201,
        ),
  ...
  it('shows a previously saved result without offering a second attempt', async () => {
    vi.spyOn(globalThis, 'fetch').mockImplementation(() =>
      json({
        available: true,
        completed: true,
        routeTitle: 'Обыкновенные дроби: стартовая проверка',
        questions: [],
        result: {
          score: 100,
          recommendedTopicId: 'topic-4',
          recommendedTopicTitle: 'Задачи и объяснение',
          recommendedLessonId: 'lesson-8',
          recommendedLessonTitle: 'Маршрут решения задачи',
          completedAt: '2026-09-10 10:00:00',
        },
      }),
    )
