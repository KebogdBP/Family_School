...
| POST   | `/students/{id}/pilot-content/david-math-grade-4` | родитель | установить Давиду полный КТП математики 4 класса: 5 разделов, 63 урока с объяснениями и тестами; повторный вызов безопасен |
