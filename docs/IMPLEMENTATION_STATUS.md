...
Реализовать полное удаление профиля ребёнка и связанных приватных файлов с повторным подтверждением родителя и интеграционным тестом семейной изоляции.
